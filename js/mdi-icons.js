...
"blank",
	...
	for (i = 0; i < ICONS.length; i++ ) {
		...
		values.push( {text: _id, value: _id, icon: ' mdi-fw icon-fw mdi mdi-' + _id + ' icon-' + _id });
	}


	tinymce.PluginManager.add('mdi_icons', function( editor, url ) {
		editor.addButton('mdi_icons', {		
			...
			onclick: function() {
				editor.windowManager.open( {
					...
					onsubmit: function( e ) {
						editor.insertContent( '[mdi-icon name="' + e.data.mdiIcon + '" size="' + e.data.mdiSize + '" color="' + e.data.mdiColor + '"]');
					}
				});
			}
		});
